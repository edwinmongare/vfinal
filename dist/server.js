        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                app.use(function (req, res, next) {
                    payload.authenticate(req, res, function (err) {
                        if (err)
                ...
                app.get("/create-order", function (req, res) {
                    ...
                    return next_utils_1.nextApp.render(req, res, "/create-order", query);
                });
                ...
                app.get("/analytics", function (req, res) {
                    ...
                    var parsedUrl = (0, url_1.parse)(req.url, true);
                    var query = parsedUrl.query;
                    return next_utils_1.nextApp.render(req, res, "/analytics", query);
                });
                ...
                app.get("/verify-certificate", function (req, res) {
                    ...
                    var parsedUrl = (0, url_1.parse)(req.url, true);
                    var query = parsedUrl.query;
                    return next_utils_1.nextApp.render(req, res, "/verify-certificate", query);
                });
                ...
                app.get("/view-orders", function (req, res) {
                    ...
                    var parsedUrl = (0, url_1.parse)(req.url, true);
                    var query = parsedUrl.query;
                    return next_utils_1.nextApp.render(req, res, "/view-orders", query);
                });
